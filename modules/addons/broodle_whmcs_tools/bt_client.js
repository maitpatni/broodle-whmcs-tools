...
function buildEmailConnectPane(){
    ...
    +'<a class="bt-email-client-item" href="https://support.microsoft.com/en-us/office/how-do-i-set-up-an-imap-account-7af3289c-3a33-46ab-bf51-93f9ef24dfdc9c00" target="_blank" rel="noopener"><div class="bt-email-client-icon" style="background:rgba(10,94,211,.08)"><svg width="22" height="22" viewBox="0 0 24 24"><path fill="#0078d4" d="M24 7.387v10.478c0 .23-.08.424-.238.583a.793.793 0 0 1-.584.238h-8.322V6.566h8.322c.23 0 .424.08.584.238.159.159.238.353.238.583zM14.856 3.673v16.654L0 17.386V6.614l14.856-2.941z"/><path fill="#fff" d="M10.268 8.882a3.39 3.39 0 0 0-1.588-1.2 3.07 3.07 0 0 0-1.2-.234c-.65 0-1.224.16-1.72.48a3.19 3.19 0 0 0-1.15 1.327c-.27.565-.405 1.2-.405 1.907 0 .67.13 1.28.39 1.83.26.55.63.98 1.11 1.29.48.31 1.03.465 1.65.465.48 0 .92-.09 1.32-.27a3.1 3.1 0 0 0 1.05-.78 3.58 3.58 0 0 0 .66-1.2l-1.56-.48c-.12.36-.32.65-.6.87-.28.22-.62.33-1.02.33-.42 0-.78-.12-1.08-.36a2.2 2.2 0 0 1-.66-.96 3.56 3.56 0 0 1-.22-1.26c0-.48.08-.92.24-1.32.16-.4.4-.72.72-.96.32-.24.7-.36 1.14-.36.36 0 .68.09.96.27.28.18.49.44.63.78l1.32-.15z"/></svg></div><span>Outlook</span><small>IMAP / Port 993</small></a>'
    +'<a class="bt-email-client-item" href="https://support.google.com/mail/answer/6078445" target="_blank" rel="noopener"><div class="bt-email-client-icon" style="background:rgba(234,67,53,.08)"><svg width="22" height="22" viewBox="0 0 24 24"><path fill="#4285f4" d="M2 6.5V18c0 1.1.9 2 2 2h1.2V8.1L12 13l6.8-4.9V20H20c1.1 0 2-.9 2-2V6.5l-1.4-2.3c-.4-.6-1-.8-1.6-.8H5c-.6 0-1.2.2-1.6.8L2 6.5z"/><path fill="#ea4335" d="M5.2 8.1V20H4c-1.1 0-2-.9-2-2V6.5l3.2 1.6z"/><path fill="#34a853" d="M18.8 8.1V20H20c1.1 0 2-.9 2-2V6.5l-3.2 1.6z"/><path fill="#fbbc04" d="M12 13L5.2 8.1 2 6.5l10 6.2 10-6.2-3.2 1.6L12 13z"/></svg></div><span>Gmail App</span><small>IMAP / Port 993</small></a>'
