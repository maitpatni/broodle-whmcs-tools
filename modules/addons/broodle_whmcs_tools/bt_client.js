...
function hideDefaultTabs(){
    // Hide default WHMCS tab navigation only
    document.querySelectorAll(".product-details-tab-container").forEach(function(el){
