...
function styleSidebarActions(){
    ...
    navs.forEach(function(nav){
        ...
        var items=nav.querySelectorAll(".list-group-item, a[id*='Login_to'], a[href*='cpanel'], a[href*='webmail']");
        ...
        items.forEach(function(item){
            ...
            // Actions panel items
            if(id.indexOf("cpanel")!==-1||text.indexOf("cpanel")!==-1||text.indexOf("login to cpanel")!==-1){
                iconHtml='<img src="'+modPath+'cpanel-icon.png" width="22" height="22" alt="cPanel" style="border-radius:50%;object-fit:contain">';
                color="rgba(255,106,0,.06)";label="Login to cPanel";
            }else if(id.indexOf("webmail")!==-1||text.indexOf("webmail")!==-1||text.indexOf("login to webmail")!==-1){
                iconHtml='<img src="'+modPath+'webmail-icon.webp" width="22" height="22" alt="Webmail" style="border-radius:50%;object-fit:contain">';
                color="rgba(10,94,211,.06)";label="Login to Webmail";
            }else if(id.indexOf("change_password")!==-1||text.indexOf("change password")!==-1){
                iconHtml='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><circle cx="12" cy="16" r="1"/></svg>';
                color="rgba(124,58,237,.08)";label="Change Password";
            }else if(text.indexOf("cancel")!==-1||id.indexOf("cancel")!==-1){
                iconHtml='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>';
                color="rgba(239,68,68,.1)";label="Request Cancellation";
            // Overview panel items
            }else if(text.indexOf("information")!==-1||id.indexOf("information")!==-1){
            ...
            }else if(text.indexOf("billing")!==-1||id.indexOf("billing")!==-1){
                iconHtml='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>';
                color="rgba(217,119,6,.08)";label="Billing";sub="Invoices & Payments";
            }else if(text.indexOf("domain")!==-1||id.indexOf("domain")!==-1){
                iconHtml='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10A15.3 15.3 0 0 1 12 2z"/></svg>';
                color="rgba(10,94,211,.08)";label="Domains";sub="Domain Management";
            }else{
            ...
            // Actions panel: label only, no description. Overview panel: label + sub.
            if(isActionsPanel||!sub){
