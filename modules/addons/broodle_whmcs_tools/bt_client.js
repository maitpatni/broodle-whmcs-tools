...
function styleSidebarActions(){
    // Style ALL sidebar panels with list-group-tab-nav items
    document.querySelectorAll(".list-group-tab-nav").forEach(function(nav){
        nav.querySelectorAll(".list-group-item").forEach(function(item){
            ...
            if(id.indexOf("cpanel")!==-1||text.indexOf("cpanel")!==-1||text.indexOf("login to cpanel")!==-1){
                ...
                color="rgba(255,106,0,.08)";label="Login to cPanel";sub="Control Panel";
                ...
                color="rgba(10,94,211,.08)";label="Login to Webmail";sub="Email Client";
                ...
                color="rgba(239,68,68,.06)";label="Request Cancellation";sub="Cancel Service";
            // Overview panel items
                ...
                svg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10A15.3 15.3 0 0 1 12 2z"/></svg>';
            ...
            labelDiv.innerHTML=esc(label)+(sub?'<span>'+esc(sub)+'</span>':'');
            item.textContent="";
