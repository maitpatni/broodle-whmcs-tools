...
function injectStyles(){
    ...
    s.id="bt-injected-styles";
    s.textContent='.bt-btn-spin{display:inline-block;vertical-align:middle;animation:btSpin .7s linear infinite}@keyframes btSpin{to{transform:rotate(360deg)}}.bt-row-btn:disabled,.bt-btn-add:disabled,.bt-btn-primary:disabled,.bt-btn-danger:disabled,.bt-btn-outline:disabled{opacity:.6;cursor:not-allowed;pointer-events:none}.product-details-tab-container,.product-details-tab-container+.tab-content,ul.panel-tabs.nav.nav-tabs{display:none!important}.quick-create-email,.quick-create-email-section,[class*="quick-create-email"],.module-quick-create-email,#cPanelQuickEmailPanel{display:none!important}#Primary_Sidebar-productdetails_addons_and_extras,#cPanelExtrasPurchasePanel,#tabAddonsExtras,.addons-and-extras-section,[id*="addons_and_extras"],[class*="addons-extras"]{display:none!important}.bt-hidden-section{display:none!important}.list-group-tab-nav .list-group-item[id*="webmail"],.list-group-tab-nav .list-group-item[id*="Webmail"],.list-group-tab-nav a[href*="webmail"]{display:none!important}.bt-wrap{margin-top:15px;margin-bottom:24px;font-family:inherit}.bt-wrap *{font-family:inherit}.bt-tabs-nav{display:flex;gap:0;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;border-bottom:2px solid var(--border-color,#e5e7eb);padding:0;margin:0}.bt-tabs-nav::-webkit-scrollbar{display:none}.bt-tab-btn{display:inline-flex;align-items:center;gap:7px;padding:12px 18px;font-size:13px;font-weight:600;color:var(--text-muted,#6b7280);cursor:pointer;border:none;background:none;white-space:nowrap;border-bottom:2px solid transparent;margin-bottom:-2px;transition:color .15s,border-color .15s;flex-shrink:0}.bt-tab-btn:hover{color:var(--heading-color,#111827)}.bt-tab-btn.active{color:#0a5ed3;border-bottom-color:#0a5ed3}.bt-tab-btn svg{width:16px;height:16px;flex-shrink:0}.bt-tab-pane{display:none;padding:20px 0 0}.bt-tab-pane.active{display:block}.bt-ov-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.bt-ov-card{background:var(--input-bg,#f8fafc);border:1px solid var(--border-color,#e5e7eb);border-radius:10px;padding:16px 18px;transition:border-color .15s,box-shadow .15s}.bt-ov-card:hover{border-color:rgba(10,94,211,.25);box-shadow:0 2px 8px rgba(10,94,211,.06)}.bt-ov-label{font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.5px;color:var(--text-muted,#9ca3af);margin:0 0 6px}.bt-ov-value{font-size:14px;font-weight:600;color:var(--heading-color,#111827);margin:0;word-break:break-word}.bt-ov-value a{color:#0a5ed3;text-decoration:none}.bt-ov-value .label,.bt-ov-value .badge{font-size:12px;padding:3px 10px;border-radius:6px;font-weight:600}.bt-ov-due-ok{color:#059669}.bt-ov-due-warn{color:#d97706}.bt-ov-due-danger{color:#ef4444}.bt-ov-due-past{color:#ef4444;font-weight:700}.bt-ov-days{display:block;font-size:11px;font-weight:500;margin-top:2px}@media(max-width:768px){.bt-ov-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:480px){.bt-ov-grid{grid-template-columns:1fr}}.bt-card{background:var(--card-bg,#fff);border:1px solid var(--border-color,#e5e7eb);border-radius:12px;overflow:hidden}.bt-card-head{display:flex;align-items:center;justify-content:space-between;padding:16px 20px;border-bottom:1px solid var(--border-color,#f3f4f6)}.bt-card-head-left{display:flex;align-items:center;gap:12px}.bt-icon-circle{width:36px;height:36px;background:#0a5ed3;border-radius:10px;display:flex;align-items:center;justify-content:center;color:#fff;flex-shrink:0}.bt-card-head h5{margin:0;font-size:15px;font-weight:600;color:var(--heading-color,#111827)}.bt-card-head p{margin:2px 0 0;font-size:12px;color:var(--text-muted,#6b7280)}.bt-card-head-right{display:flex;gap:8px}.bt-list{padding:6px 8px}.bt-ns-section{margin-top:20px}.bt-upgrades{margin-top:20px;padding:18px 20px;background:var(--input-bg,#f8fafc);border:1px solid var(--border-color,#e5e7eb);border-radius:12px}.bt-upgrades h4{margin:0 0 14px;font-size:14px;font-weight:700;color:var(--heading-color,#111827);display:flex;align-items:center;gap:8px}.bt-upgrades h4 svg{color:#0a5ed3}.bt-upgrades .panel,.bt-upgrades .card{border:none;box-shadow:none;margin:0;background:transparent}.bt-upgrades .panel-heading,.bt-upgrades .card-header{display:none}.bt-upgrades .panel-body,.bt-upgrades .card-body{padding:0}.bt-row{display:flex;align-items:center;gap:12px;padding:12px 14px;border-radius:9px;transition:background .15s}.bt-row:hover{background:var(--input-bg,#f9fafb)}.bt-row+.bt-row{border-top:1px solid var(--border-color,#f3f4f6)}.bt-row-icon{width:34px;height:34px;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0}.bt-row-icon.ns{background:rgba(10,94,211,.08);color:#0a5ed3}.bt-row-icon.ip{background:rgba(5,150,105,.08);color:#059669}.bt-row-icon.email{background:rgba(10,94,211,.08);color:#0a5ed3;border-radius:50%}.bt-row-icon.main{background:rgba(10,94,211,.08);color:#0a5ed3}.bt-row-icon.addon{background:rgba(5,150,105,.08);color:#059669}.bt-row-icon.sub{background:rgba(124,58,237,.08);color:#7c3aed}.bt-row-icon.parked{background:rgba(217,119,6,.08);color:#d97706}.bt-row-icon.db{background:rgba(10,94,211,.08);color:#0a5ed3}.bt-row-icon.dbuser{background:rgba(124,58,237,.08);color:#7c3aed}.bt-row-info{flex:1;min-width:0;display:flex;align-items:center;gap:8px;overflow:hidden}.bt-row-name{font-size:14px;font-weight:500;color:var(--heading-color,#111827);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bt-row-name.mono{font-family:"SFMono-Regular",Consolas,"Liberation Mono",Menlo,monospace}.bt-row-badge{padding:2px 8px;border-radius:10px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.3px;flex-shrink:0}.bt-badge-primary{background:rgba(10,94,211,.08);color:#0a5ed3}.bt-badge-green{background:rgba(5,150,105,.08);color:#059669}.bt-badge-purple{background:rgba(124,58,237,.08);color:#7c3aed}.bt-badge-amber{background:rgba(217,119,6,.08);color:#d97706}.bt-row-actions{display:flex;gap:6px;flex-shrink:0}.bt-row-btn{display:inline-flex;align-items:center;gap:5px;padding:5px 10px;border-radius:6px;font-size:11px;font-weight:600;cursor:pointer;border:1px solid var(--border-color,#e5e7eb);background:var(--card-bg,#fff);transition:all .15s;white-space:nowrap;text-decoration:none;color:var(--heading-color,#374151)}.bt-row-btn span{display:none}.bt-row-btn:hover span{display:inline}.bt-row-btn:hover{border-color:#0a5ed3;color:#0a5ed3}.bt-row-btn.login{color:#0a5ed3}.bt-row-btn.login:hover{background:rgba(10,94,211,.06);border-color:#0a5ed3}.bt-row-btn.visit{color:#0a5ed3}.bt-row-btn.visit:hover{background:rgba(10,94,211,.06);border-color:#0a5ed3;text-decoration:none;color:#0a5ed3}.bt-row-btn.pass{color:#d97706}.bt-row-btn.pass:hover{background:rgba(217,119,6,.06);border-color:#d97706}.bt-row-btn.del{color:#ef4444}.bt-row-btn.del:hover{background:rgba(239,68,68,.06);border-color:#ef4444}.bt-copy{width:32px;height:32px;display:flex;align-items:center;justify-content:center;border:1px solid var(--border-color,#e5e7eb);border-radius:7px;background:var(--card-bg,#fff);color:var(--text-muted,#9ca3af);cursor:pointer;transition:all .15s;flex-shrink:0}.bt-copy:hover{color:#0a5ed3;border-color:#0a5ed3}.bt-copy.copied{color:#fff;background:#059669;border-color:#059669}.bt-empty{padding:30px 22px;text-align:center;color:var(--text-muted,#9ca3af);font-size:14px;display:flex;flex-direction:column;align-items:center;gap:10px}.bt-empty svg{opacity:.4}.bt-btn-add{display:inline-flex;align-items:center;gap:6px;padding:7px 16px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;border:none;background:#0a5ed3;color:#fff;transition:background .15s}.bt-btn-add:hover{background:#0950b3}.bt-btn-outline{display:inline-flex;align-items:center;gap:6px;padding:7px 14px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;border:1px solid var(--border-color,#d1d5db);background:var(--card-bg,#fff);color:var(--heading-color,#374151);transition:all .15s}.bt-btn-outline:hover{border-color:#0a5ed3;color:#0a5ed3;background:rgba(10,94,211,.04)}.bt-accordion{margin-top:20px;border:1px solid var(--border-color,#e5e7eb);border-radius:12px;overflow:visible;background:var(--card-bg,#fff)}.bt-accordion-head{display:flex;align-items:center;gap:12px;padding:14px 18px;cursor:pointer;user-select:none;transition:background .12s;border-radius:12px}.bt-accordion-head:hover{background:var(--input-bg,#f9fafb)}.bt-accordion-icon{width:36px;height:36px;border-radius:10px;background:#0a5ed3;display:flex;align-items:center;justify-content:center;color:#fff;flex-shrink:0}.bt-accordion-info{flex:1;min-width:0}.bt-accordion-info h5{margin:0;font-size:14px;font-weight:600;color:var(--heading-color,#111827)}.bt-accordion-info p{margin:2px 0 0;font-size:12px;color:var(--text-muted,#6b7280)}.bt-accordion-arrow{width:20px;height:20px;color:var(--text-muted,#9ca3af);transition:transform .25s ease;flex-shrink:0}.bt-accordion.open .bt-accordion-arrow{transform:rotate(180deg)}.bt-accordion-body{max-height:0;overflow:hidden;transition:max-height .3s ease,overflow 0s .3s}.bt-accordion.open .bt-accordion-body{max-height:800px;overflow:visible;transition:max-height .3s ease,overflow 0s 0s}.bt-addons-section{margin-top:20px}.bt-addon-wrap{position:relative;padding:0 36px 6px}.bt-addon-scroll{display:flex;gap:0;overflow-x:auto;scroll-snap-type:x mandatory;-webkit-overflow-scrolling:touch;scrollbar-width:none;padding:0;cursor:grab;user-select:none}.bt-addon-scroll::-webkit-scrollbar{display:none}.bt-addon-scroll.dragging{cursor:grabbing;scroll-snap-type:none;scroll-behavior:auto}.bt-addon-page{min-width:100%;flex-shrink:0;scroll-snap-align:start;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr 1fr;gap:2px 0;padding:6px 4px}.bt-addon-item{display:flex;align-items:center;gap:10px;padding:12px 14px;border-radius:10px;transition:background .12s;min-height:54px}.bt-addon-item:hover{background:var(--input-bg,#f5f7fa)}.bt-addon-icon{width:36px;height:36px;border-radius:9px;display:flex;align-items:center;justify-content:center;flex-shrink:0}.bt-addon-icon.addon{background:rgba(124,58,237,.08);color:#7c3aed}.bt-addon-icon.upgrade{background:rgba(5,150,105,.08);color:#059669}.bt-addon-text{flex:1;min-width:0;overflow:hidden}.bt-addon-name{font-size:13px;font-weight:500;color:var(--heading-color,#111827);display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bt-addon-price{font-size:11px;color:#0a5ed3;font-weight:600;margin-top:1px;display:none}.bt-addon-price.visible{display:block}.bt-addon-btn{display:inline-flex;align-items:center;gap:4px;padding:5px 12px;border-radius:7px;font-size:11px;font-weight:600;cursor:pointer;border:1px solid var(--border-color,#e5e7eb);background:var(--card-bg,#fff);color:var(--heading-color,#374151);transition:all .12s;white-space:nowrap;text-decoration:none;flex-shrink:0}.bt-addon-btn:hover{border-color:#0a5ed3;color:#0a5ed3;background:rgba(10,94,211,.04);text-decoration:none}.bt-addon-dots{display:flex;justify-content:center;gap:6px;padding:10px 0 4px}.bt-addon-dot{width:6px;height:6px;border-radius:50%;background:var(--border-color,#d1d5db);border:none;padding:0;cursor:pointer;transition:all .2s}.bt-addon-dot.active{background:#0a5ed3;width:18px;border-radius:3px}.bt-addon-nav{position:absolute;top:50%;transform:translateY(-60%);width:30px;height:30px;border-radius:50%;border:1px solid var(--border-color,#e5e7eb);background:var(--card-bg,#fff);color:var(--text-muted,#6b7280);display:flex;align-items:center;justify-content:center;cursor:pointer;transition:all .15s;z-index:2;box-shadow:0 2px 6px rgba(0,0,0,.1)}.bt-addon-nav:hover{border-color:#0a5ed3;color:#0a5ed3;box-shadow:0 2px 8px rgba(10,94,211,.15)}.bt-addon-nav.prev{left:0}.bt-addon-nav.next{right:0}.bt-addon-nav.hidden{opacity:0;pointer-events:none}.bt-addon-tip-wrap{position:relative;flex-shrink:0;margin-right:2px}.bt-addon-tip-btn{width:18px;height:18px;border-radius:50%;border:none;background:transparent;color:var(--text-muted,#c0c5cc);display:flex;align-items:center;justify-content:center;cursor:pointer;transition:color .12s;padding:0}.bt-addon-tip-btn:hover{color:#0a5ed3}.bt-addon-tip-btn.loading{opacity:.4}.bt-addon-tooltip{position:fixed;width:340px;max-width:90vw;max-height:200px;overflow-y:auto;overflow-x:hidden;padding:12px 15px;background:#1f2937;color:#f3f4f6;font-size:12px;line-height:1.55;border-radius:9px;box-shadow:0 8px 28px rgba(0,0,0,.22);z-index:99999;word-wrap:break-word;opacity:0;visibility:hidden;transition:opacity .12s,visibility .12s;pointer-events:none}.bt-addon-tooltip.visible{opacity:1;visibility:visible;pointer-events:auto}.bt-addon-tooltip::-webkit-scrollbar{display:none}.bt-addon-tooltip{scrollbar-width:none}.bt-addon-tooltip::after{display:none}@media(max-width:600px){.bt-addon-page{grid-template-columns:1fr;grid-template-rows:repeat(4,1fr)}.bt-addon-wrap{padding:0 30px 6px}.bt-addon-tooltip{width:280px}}.bt-ssl-row .bt-row-info{flex-wrap:wrap}.bt-ssl-meta{display:flex;align-items:center;gap:12px;flex-shrink:0;font-size:11px;color:var(--text-muted,#6b7280)}.bt-ssl-meta span{display:inline-flex;align-items:center;gap:4px;white-space:nowrap}.bt-ssl-issuer{color:var(--text-muted,#6b7280)}.bt-ssl-days-ok{color:#059669}.bt-ssl-days-warn{color:#d97706}.bt-ssl-days-danger{color:#ef4444}.bt-row-icon.ssl-valid{background:rgba(5,150,105,.08);color:#059669}.bt-row-icon.ssl-selfsigned{background:rgba(217,119,6,.08);color:#d97706}.bt-row-icon.ssl-expired{background:rgba(239,68,68,.08);color:#ef4444}.bt-row-icon.ssl-expiring{background:rgba(217,119,6,.08);color:#d97706}.bt-badge-red{background:rgba(239,68,68,.08);color:#ef4444}.bt-ssl-generate:hover{background:rgba(5,150,105,.06)!important}@media(max-width:600px){.bt-ssl-meta{flex-direction:column;align-items:flex-start;gap:4px}}.bt-log-line{display:flex;gap:0;font-family:\"SFMono-Regular\",Consolas,\"Liberation Mono\",Menlo,monospace;font-size:12px;line-height:1.6;border-radius:3px;transition:background .1s}.bt-log-line:hover{background:rgba(255,255,255,.05)}.bt-log-num{min-width:40px;padding:1px 10px 1px 0;text-align:right;color:rgba(148,163,184,.4);user-select:none;flex-shrink:0;border-right:1px solid rgba(148,163,184,.1);margin-right:10px}.bt-log-text{color:#e2e8f0;word-break:break-all;white-space:pre-wrap}.bt-log-error .bt-log-text{color:#fca5a5}.bt-log-fatal .bt-log-text{color:#f87171;font-weight:600}.bt-log-warn .bt-log-text{color:#fcd34d}.bt-log-info .bt-log-text{color:#93c5fd}.bt-overlay{position:fixed;inset:0;z-index:100000;background:rgba(0,0,0,.45);display:flex;align-items:center;justify-content:center;padding:20px;animation:btFadeIn .2s}@keyframes btFadeIn{from{opacity:0}to{opacity:1}}.bt-modal{background:var(--card-bg,#fff);border-radius:14px;width:100%;max-width:440px;box-shadow:0 20px 60px rgba(0,0,0,.2);animation:btSlideUp .25s}.bt-modal-sm{max-width:380px}@keyframes btSlideUp{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:translateY(0)}}.bt-modal-head{display:flex;align-items:center;justify-content:space-between;padding:18px 22px;border-bottom:1px solid var(--border-color,#f3f4f6)}.bt-modal-head h5{margin:0;font-size:16px;font-weight:600;color:var(--heading-color,#111827)}.bt-modal-close{width:30px;height:30px;display:flex;align-items:center;justify-content:center;border:none;background:none;font-size:20px;color:var(--text-muted,#9ca3af);border-radius:6px;cursor:pointer;transition:all .15s}.bt-modal-close:hover{background:var(--input-bg,#f3f4f6);color:var(--heading-color,#111827)}.bt-modal-body{padding:20px 22px}.bt-modal-foot{display:flex;justify-content:flex-end;gap:8px;padding:14px 22px;border-top:1px solid var(--border-color,#f3f4f6)}.bt-field{margin-bottom:16px}.bt-field:last-child{margin-bottom:0}.bt-field label{display:block;font-size:12px;font-weight:600;color:var(--text-muted,#6b7280);margin-bottom:6px;text-transform:uppercase;letter-spacing:.3px}.bt-field input,.bt-field select,.bt-select{width:100%;padding:9px 12px;border:1px solid var(--border-color,#d1d5db);border-radius:8px;font-size:14px;color:var(--heading-color,#111827);background:var(--input-bg,#fff);outline:none;transition:border-color .15s;box-sizing:border-box}.bt-field input:focus,.bt-field select:focus,.bt-select:focus{border-color:#0a5ed3;box-shadow:0 0 0 3px rgba(10,94,211,.1)}.bt-field input[readonly]{background:var(--input-bg,#f9fafb);color:var(--text-muted,#6b7280)}.bt-input-group{display:flex;align-items:center;border:1px solid var(--border-color,#d1d5db);border-radius:8px;overflow:hidden;transition:border-color .15s}.bt-input-group:focus-within{border-color:#0a5ed3;box-shadow:0 0 0 3px rgba(10,94,211,.1)}.bt-input-group input{border:none;border-radius:0;flex:1;min-width:0}.bt-input-group input:focus{box-shadow:none}.bt-at,.bt-prefix{padding:0 10px;font-size:13px;color:var(--text-muted,#9ca3af);font-weight:600;background:var(--input-bg,#f9fafb);border-right:1px solid var(--border-color,#e5e7eb);height:100%;display:flex;align-items:center;white-space:nowrap;flex-shrink:0}.bt-input-group select{border:none;border-radius:0;flex:1;min-width:0}.bt-input-group select:focus{box-shadow:none}.bt-pass-wrap{position:relative}.bt-pass-wrap input{width:100%;padding-right:40px}.bt-pass-toggle{position:absolute;right:8px;top:50%;transform:translateY(-50%);background:none;border:none;color:var(--text-muted,#9ca3af);cursor:pointer;padding:4px}.bt-pass-toggle:hover{color:var(--heading-color,#111827)}.bt-docroot-wrap{display:flex;align-items:center;border:1px solid var(--border-color,#d1d5db);border-radius:8px;overflow:hidden;transition:border-color .15s}.bt-docroot-wrap:focus-within{border-color:#0a5ed3;box-shadow:0 0 0 3px rgba(10,94,211,.1)}.bt-docroot-prefix{padding:9px 10px;font-size:13px;color:var(--text-muted,#9ca3af);background:var(--input-bg,#f9fafb);border-right:1px solid var(--border-color,#e5e7eb);white-space:nowrap;flex-shrink:0}.bt-docroot-wrap input{border:none;border-radius:0;flex:1;min-width:0;padding:9px 12px;font-size:14px;outline:none}.bt-docroot-wrap input:focus{box-shadow:none}.bt-btn-cancel{padding:8px 18px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;border:none;background:var(--input-bg,#f3f4f6);color:var(--heading-color,#374151);transition:all .15s}.bt-btn-cancel:hover{background:#e5e7eb}.bt-btn-primary{padding:8px 18px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;border:none;background:#0a5ed3;color:#fff;transition:all .15s}.bt-btn-primary:hover{background:#0950b3}.bt-btn-danger{padding:8px 18px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;border:none;background:#ef4444;color:#fff;transition:all .15s}.bt-btn-danger:hover{background:#dc2626}.bt-btn-primary:disabled,.bt-btn-danger:disabled,.bt-btn-add:disabled{opacity:.5;cursor:not-allowed}.bt-msg{margin-top:12px;padding:8px 12px;border-radius:6px;font-size:13px;display:none}.bt-msg.success{display:block;background:rgba(5,150,105,.08);color:#059669}.bt-msg.error{display:block;background:rgba(239,68,68,.08);color:#ef4444}.bt-checkbox{display:flex;align-items:center;gap:8px;font-size:14px;font-weight:500;color:var(--heading-color,#111827);cursor:pointer;text-transform:none;letter-spacing:0}.bt-checkbox input{width:16px;height:16px;accent-color:#0a5ed3}.bt-loading{padding:40px 22px;text-align:center;color:var(--text-muted,#9ca3af);font-size:14px;display:flex;flex-direction:column;align-items:center;gap:12px}.bt-spinner{width:28px;height:28px;border:3px solid var(--border-color,#e5e7eb);border-top-color:#0a5ed3;border-radius:50%;animation:btSpin .7s linear infinite}@keyframes btSpin{to{transform:rotate(360deg)}}.bwp-detail-panel{width:100%;max-width:900px;max-height:90vh;background:var(--card-bg,#fff);border-radius:16px;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 25px 60px rgba(0,0,0,.25);animation:btSlideUp .3s}.bwp-detail-head{display:flex;align-items:center;gap:12px;padding:14px 20px;border-bottom:1px solid var(--border-color,#f3f4f6);flex-shrink:0}.bwp-detail-head h5{flex:1;margin:0;font-size:14px;font-weight:700;color:var(--heading-color,#111827);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bwp-detail-tabs{display:flex;gap:0;padding:0 20px;border-bottom:1px solid var(--border-color,#f3f4f6);flex-shrink:0;overflow-x:auto}.bwp-tab{padding:10px 14px;font-size:12px;font-weight:600;color:var(--text-muted,#6b7280);cursor:pointer;border:none;background:none;border-bottom:2px solid transparent;transition:all .15s;white-space:nowrap}.bwp-tab:hover{color:var(--heading-color,#111827)}.bwp-tab.active{color:#0a5ed3;border-bottom-color:#0a5ed3}.bwp-detail-body{flex:1;overflow-y:auto;padding:0}.bwp-tab-content{display:none;padding:18px 20px}.bwp-tab-content.active{display:block}.bwp-site{display:flex;align-items:center;gap:14px;padding:14px;border-radius:9px;transition:background .15s;cursor:pointer}.bwp-site:hover{background:var(--input-bg,#f9fafb)}.bwp-site+.bwp-site{border-top:1px solid var(--border-color,#f3f4f6)}.bwp-site-icon{width:40px;height:40px;border-radius:10px;background:rgba(10,94,211,.08);color:#0a5ed3;display:flex;align-items:center;justify-content:center;flex-shrink:0}.bwp-site-info{flex:1;min-width:0}.bwp-site-domain{font-size:14px;font-weight:600;color:var(--heading-color,#111827);margin:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bwp-site-meta{font-size:12px;color:var(--text-muted,#6b7280);margin:2px 0 0;display:flex;gap:12px;flex-wrap:wrap}.bwp-site-meta span{display:inline-flex;align-items:center;gap:4px}.bwp-site-actions{display:flex;gap:6px;flex-shrink:0}.bwp-status-badge{display:inline-flex;align-items:center;gap:4px;padding:2px 8px;border-radius:10px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.3px}.bwp-status-badge.active{background:rgba(5,150,101,.08);color:#059669}.bwp-status-badge.inactive{background:rgba(217,119,6,.08);color:#d97706}.bwp-status-badge.update-available{background:rgba(10,94,211,.08);color:#0a5ed3}.bwp-overview-hero{display:flex;gap:18px;align-items:flex-start}.bwp-preview-col{flex-shrink:0;width:300px;display:flex;flex-direction:column;gap:8px}.bwp-overview-right{flex:1;min-width:0}.bwp-preview-wrap{border-radius:10px;overflow:hidden;border:1px solid var(--border-color,#e5e7eb);background:#f9fafb}.bwp-preview-bar{display:flex;align-items:center;gap:6px;padding:5px 10px;background:var(--input-bg,#f3f4f6);border-bottom:1px solid var(--border-color,#e5e7eb)}.bwp-preview-dots{display:flex;gap:4px}.bwp-preview-dots span{width:7px;height:7px;border-radius:50%}.bwp-preview-dots span:nth-child(1){background:#ef4444}.bwp-preview-dots span:nth-child(2){background:#f59e0b}.bwp-preview-dots span:nth-child(3){background:#22c55e}.bwp-preview-url{flex:1;font-size:9px;color:var(--text-muted,#6b7280);background:var(--card-bg,#fff);padding:2px 7px;border-radius:4px;border:1px solid var(--border-color,#e5e7eb);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-family:monospace}.bwp-preview-frame-wrap{width:100%;height:187px;overflow:hidden;position:relative;background:var(--input-bg,#f3f4f6)}.bwp-quick-actions{display:flex;gap:6px;flex-wrap:wrap}.bwp-site-header{display:flex;align-items:center;gap:12px;padding:12px 14px;background:var(--input-bg,#f9fafb);border-radius:10px;border:1px solid var(--border-color,#f3f4f6);margin-bottom:12px}.bwp-site-header-icon{width:40px;height:40px;border-radius:10px;background:#0a5ed3;color:#fff;display:flex;align-items:center;justify-content:center;flex-shrink:0}.bwp-site-header-info{flex:1;min-width:0}.bwp-site-header-info h4{margin:0;font-size:14px;font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bwp-site-header-info p{margin:2px 0 0;font-size:11px;color:var(--text-muted,#6b7280);display:flex;gap:8px;flex-wrap:wrap}.bwp-overview-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:14px}.bwp-stat{padding:10px 12px;background:var(--input-bg,#f9fafb);border-radius:8px;border:1px solid var(--border-color,#f3f4f6)}.bwp-stat-label{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:var(--text-muted,#9ca3af);margin:0 0 2px}.bwp-stat-value{font-size:13px;font-weight:600;color:var(--heading-color,#111827);margin:0;word-break:break-all}.bwp-item-row{display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid var(--border-color,#f3f4f6)}.bwp-item-row:last-child{border-bottom:none}.bwp-item-icon{width:32px;height:32px;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:14px}.bwp-item-icon.plugin{background:rgba(10,94,211,.08);color:#0a5ed3}.bwp-item-icon.theme{background:rgba(124,58,237,.08);color:#7c3aed}.bwp-item-info{flex:1;min-width:0}.bwp-item-name{font-size:12px;font-weight:600;color:var(--heading-color,#111827);margin:0}.bwp-item-detail{font-size:10px;color:var(--text-muted,#6b7280);margin:2px 0 0}.bwp-item-actions{display:flex;gap:4px;flex-shrink:0}.bwp-item-btn{padding:4px 10px;border-radius:6px;font-size:11px;font-weight:600;cursor:pointer;border:1px solid var(--border-color,#e5e7eb);background:var(--card-bg,#fff);transition:all .15s}.bwp-item-btn:hover{border-color:#0a5ed3;color:#0a5ed3}.bwp-item-btn.active-state{color:#059669;border-color:#059669}.bwp-item-btn.inactive-state{color:#d97706;border-color:#d97706}.bwp-item-btn.update{color:#0a5ed3;border-color:#0a5ed3}.bwp-item-btn.delete{color:#ef4444;border-color:#ef4444}.bwp-item-btn:disabled{opacity:.5;cursor:not-allowed}.bwp-theme-grid{display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px}.bwp-theme-card{border:1px solid var(--border-color,#e5e7eb);border-radius:12px;overflow:hidden;background:var(--card-bg,#fff);transition:box-shadow .2s}.bwp-theme-card:hover{box-shadow:0 4px 16px rgba(0,0,0,.08)}.bwp-theme-active{border-color:#0a5ed3;box-shadow:0 0 0 2px rgba(10,94,211,.15)}.bwp-theme-screenshot{position:relative;width:100%;padding-top:66%;background:var(--input-bg,#f3f4f6);overflow:hidden}.bwp-theme-screenshot img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.bwp-theme-active-badge{position:absolute;top:8px;right:8px;background:#0a5ed3;color:#fff;padding:3px 10px;border-radius:6px;font-size:10px;font-weight:700;text-transform:uppercase}.bwp-theme-info{padding:12px 14px}.bwp-theme-name{font-size:13px;font-weight:600;margin:0 0 4px}.bwp-theme-ver{font-size:11px;color:var(--text-muted,#6b7280);margin:0 0 8px}.bwp-theme-actions{display:flex;gap:6px}.bwp-sec-summary{margin-bottom:20px;padding:16px;background:var(--input-bg,#f9fafb);border-radius:12px;border:1px solid var(--border-color,#f3f4f6)}.bwp-sec-summary-bar{height:8px;background:var(--border-color,#e5e7eb);border-radius:4px;overflow:hidden;margin-bottom:10px}.bwp-sec-summary-fill{height:100%;background:linear-gradient(90deg,#059669,#22c55e);border-radius:4px;transition:width .5s}.bwp-sec-summary-text{display:flex;gap:16px;font-size:13px}.bwp-security-item{display:flex;align-items:center;gap:14px;padding:14px 0;border-bottom:1px solid var(--border-color,#f3f4f6)}.bwp-security-item:last-child{border-bottom:none}.bwp-sec-icon{width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0}.bwp-sec-icon.ok{background:rgba(5,150,101,.08);color:#059669}.bwp-sec-icon.warning{background:rgba(217,119,6,.08);color:#d97706}.bwp-sec-info{flex:1}.bwp-sec-label{font-size:13px;font-weight:600;margin:0}.bwp-sec-detail{font-size:12px;color:var(--text-muted,#6b7280);margin:2px 0 0}.bwp-sec-value{font-size:12px;font-weight:600;flex-shrink:0}.bwp-sec-value.ok{color:#059669}.bwp-sec-value.warning{color:#d97706}.bwp-msg{padding:10px 14px;border-radius:8px;font-size:13px;margin-bottom:12px}.bwp-msg.success{background:rgba(5,150,101,.08);color:#059669}.bwp-msg.error{background:rgba(239,68,68,.08);color:#ef4444}.bwp-msg.info{background:rgba(10,94,211,.08);color:#0a5ed3}.list-group-tab-nav{display:flex;flex-direction:column;gap:10px;padding:10px 12px}.list-group-tab-nav .list-group-item{display:flex!important;align-items:center;gap:10px;padding:11px 14px;border-radius:8px;border:1px solid var(--border-color,#e5e7eb);background:var(--card-bg,#fff);color:var(--heading-color,#1f2937);font-size:13px;font-weight:600;text-decoration:none;transition:all .15s ease;box-shadow:0 1px 2px rgba(0,0,0,.03);position:relative}.list-group-tab-nav .list-group-item:hover{border-color:rgba(10,94,211,.25);box-shadow:0 2px 8px rgba(10,94,211,.08);transform:translateY(-1px);color:#0a5ed3}.list-group-tab-nav .list-group-item .fas,.list-group-tab-nav .list-group-item .fa,.list-group-tab-nav .list-group-item .far,.list-group-tab-nav .list-group-item .fab,.list-group-tab-nav .list-group-item .fal,.list-group-tab-nav .list-group-item .lm,.list-group-tab-nav .list-group-item .ls{display:none!important}.list-group-tab-nav .list-group-item .loading{position:absolute;right:14px;top:50%;transform:translateY(-50%)}.list-group-tab-nav .list-group-item .bt-action-icon{width:34px;height:34px;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0}.list-group-tab-nav .list-group-item .bt-action-icon svg{width:18px;height:18px}.list-group-tab-nav .list-group-item .bt-action-label{display:flex;flex-direction:column;gap:1px}.list-group-tab-nav .list-group-item .bt-action-label span{font-size:10px;font-weight:500;color:var(--text-muted,#6b7280)}.list-group-tab-nav .bt-act-cpanel::before,.list-group-tab-nav .bt-act-password::before,.list-group-tab-nav .bt-act-cancel::before,.list-group-tab-nav .bt-act-upgrade::before,.list-group-tab-nav .bt-act-renew::before{content:"";width:34px;height:34px;border-radius:8px;flex-shrink:0;display:flex;align-items:center;justify-content:center;background-size:24px 24px;background-repeat:no-repeat;background-position:center}.list-group-tab-nav .bt-act-cpanel::before{background-color:#ff6c2c;background-image:url(modules/addons/broodle_whmcs_tools/cpanel-icon.png);background-size:22px 22px;background-repeat:no-repeat;background-position:center;border-radius:8px}.list-group-tab-nav .bt-act-password::before{background-color:#ff6c2c;background-image:url("data:image/svg+xml,%3Csvg viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23fff%27 stroke-width=%272%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Crect x=%273%27 y=%2711%27 width=%2718%27 height=%2711%27 rx=%272%27/%3E%3Cpath d=%27M7 11V7a5 5 0 0 1 10 0v4%27/%3E%3Ccircle cx=%2712%27 cy=%2716%27 r=%271%27/%3E%3C/svg%3E");background-size:18px 18px}.list-group-tab-nav .bt-act-cancel::before{background-color:rgba(239,68,68,.1);background-image:url("data:image/svg+xml,%3Csvg viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23ef4444%27 stroke-width=%272%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Ccircle cx=%2712%27 cy=%2712%27 r=%2710%27/%3E%3Cline x1=%2715%27 y1=%279%27 x2=%279%27 y2=%2715%27/%3E%3Cline x1=%279%27 y1=%279%27 x2=%2715%27 y2=%2715%27/%3E%3C/svg%3E");background-size:18px 18px}.list-group-tab-nav .bt-act-upgrade::before{background-color:#ff6c2c;background-image:url("data:image/svg+xml,%3Csvg viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23fff%27 stroke-width=%272%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cpolyline points=%2717 1 21 5 17 9%27/%3E%3Cpath d=%27M3 11V9a4 4 0 0 1 4-4h14%27/%3E%3Cpolyline points=%277 23 3 19 7 15%27/%3E%3Cpath d=%27M21 13v2a4 4 0 0 1-4 4H3%27/%3E%3C/svg%3E");background-size:18px 18px}.list-group-tab-nav .bt-act-renew::before{background-color:#ff6c2c;background-image:url("data:image/svg+xml,%3Csvg viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23fff%27 stroke-width=%272%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cpolyline points=%2723 4 23 10 17 10%27/%3E%3Cpath d=%27M20.49 15a9 9 0 1 1-2.12-9.36L23 10%27/%3E%3C/svg%3E");background-size:18px 18px}.list-group-tab-nav .bt-act-cpanel:hover::before{background-color:#e55e22}.list-group-tab-nav .bt-act-password:hover::before{background-color:#e55e22}.list-group-tab-nav .bt-act-cancel:hover::before{background-color:rgba(239,68,68,.16)}.list-group-tab-nav .bt-act-upgrade:hover::before{background-color:#e55e22}.list-group-tab-nav .bt-act-renew:hover::before{background-color:#e55e22}.list-group-tab-nav .list-group-item[id*="cpanel"] .bt-action-icon{background:rgba(255,106,0,.08);color:#ff6a00}.list-group-tab-nav .list-group-item[id*="webmail"] .bt-action-icon{background:rgba(10,94,211,.08);color:#0a5ed3}.list-group-tab-nav .list-group-item[id*="Change_Password"] .bt-action-icon{background:rgba(124,58,237,.08);color:#7c3aed}.list-group-tab-nav .list-group-item[id*="Cancel"] .bt-action-icon{background:rgba(239,68,68,.1);color:#ef4444}.panel-actions .panel-heading,.sidebar-header-wrapper{border-bottom:none;padding:12px 14px 2px}.panel-actions .panel-heading .panel-title{font-size:11px;font-weight:700;color:var(--text-muted,#6b7280);letter-spacing:.4px;text-transform:uppercase}.panel-actions .panel-heading .panel-title .fas.fa-wrench{color:var(--text-muted,#9ca3af)}.panel-default>.panel-heading{border-bottom:none;padding:12px 14px 2px}.panel-default>.panel-heading .panel-title{font-size:11px;font-weight:700;color:var(--text-muted,#6b7280);letter-spacing:.4px;text-transform:uppercase}.bt-dns-toolbar{border-bottom:1px solid var(--border-color,#f3f4f6)}.bt-dns-filter-bar{border-bottom:1px solid var(--border-color,#f3f4f6);background:var(--input-bg,#fafbfc)}.bt-dns-record-row{gap:10px;align-items:flex-start;padding:10px 14px}.bt-dns-record-row .bt-row-info{gap:2px}.bt-dns-record-row .bt-row-actions{margin-top:2px}.bt-dns-domain-row:hover{background:var(--input-bg,#f5f7fa)}.bt-dns-filter-btn:hover{border-color:#0a5ed3!important;color:#0a5ed3!important}#btDnsAddFields textarea,#btDnsEditFields textarea{outline:none;transition:border-color .15s}#btDnsAddFields textarea:focus,#btDnsEditFields textarea:focus{border-color:#0a5ed3;box-shadow:0 0 0 3px rgba(10,94,211,.1)}[data-theme="dark"] .bt-tabs-nav,.dark-mode .bt-tabs-nav{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bt-tab-btn,.dark-mode .bt-tab-btn{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-tab-btn:hover,.dark-mode .bt-tab-btn:hover{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-tab-btn.active,.dark-mode .bt-tab-btn.active{color:#5b9cf6;border-bottom-color:#5b9cf6}[data-theme="dark"] .bt-ov-card,.dark-mode .bt-ov-card{background:var(--input-bg,#111827);border-color:var(--border-color,#374151)}[data-theme="dark"] .bt-ov-card:hover,.dark-mode .bt-ov-card:hover{border-color:rgba(91,156,246,.3);box-shadow:0 2px 8px rgba(91,156,246,.08)}[data-theme="dark"] .bt-ov-label,.dark-mode .bt-ov-label{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-ov-value,.dark-mode .bt-ov-value{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-ov-value a,.dark-mode .bt-ov-value a{color:#5b9cf6}[data-theme="dark"] .bt-card,.dark-mode .bt-card{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151)}[data-theme="dark"] .bt-card-head,.dark-mode .bt-card-head{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bt-card-head h5,.dark-mode .bt-card-head h5{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-card-head p,.dark-mode .bt-card-head p{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-row+.bt-row,.dark-mode .bt-row+.bt-row{border-top-color:var(--border-color,#374151)}[data-theme="dark"] .bt-row:hover,.dark-mode .bt-row:hover{background:var(--input-bg,#111827)}[data-theme="dark"] .bt-row-name,.dark-mode .bt-row-name{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-row-btn,.dark-mode .bt-row-btn{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-row-btn:hover,.dark-mode .bt-row-btn:hover{border-color:#5b9cf6;color:#5b9cf6}[data-theme="dark"] .bt-row-btn.login,.dark-mode .bt-row-btn.login{color:#5b9cf6}[data-theme="dark"] .bt-row-btn.visit,.dark-mode .bt-row-btn.visit{color:#5b9cf6}[data-theme="dark"] .bt-row-btn.pass,.dark-mode .bt-row-btn.pass{color:#fbbf24}[data-theme="dark"] .bt-row-btn.del,.dark-mode .bt-row-btn.del{color:#f87171}[data-theme="dark"] .bt-copy,.dark-mode .bt-copy{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-copy:hover,.dark-mode .bt-copy:hover{color:#5b9cf6;border-color:#5b9cf6}[data-theme="dark"] .bt-empty,.dark-mode .bt-empty{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-btn-add,.dark-mode .bt-btn-add{background:#2563eb;color:#fff}[data-theme="dark"] .bt-btn-add:hover,.dark-mode .bt-btn-add:hover{background:#1d4ed8}[data-theme="dark"] .bt-btn-outline,.dark-mode .bt-btn-outline{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-btn-outline:hover,.dark-mode .bt-btn-outline:hover{border-color:#5b9cf6;color:#5b9cf6;background:rgba(91,156,246,.06)}[data-theme="dark"] .bt-btn-cancel,.dark-mode .bt-btn-cancel{background:var(--input-bg,#374151);color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-btn-cancel:hover,.dark-mode .bt-btn-cancel:hover{background:#4b5563}[data-theme="dark"] .bt-btn-primary,.dark-mode .bt-btn-primary{background:#2563eb}[data-theme="dark"] .bt-btn-primary:hover,.dark-mode .bt-btn-primary:hover{background:#1d4ed8}[data-theme="dark"] .bt-overlay,.dark-mode .bt-overlay{background:rgba(0,0,0,.6)}[data-theme="dark"] .bt-modal,.dark-mode .bt-modal{background:var(--card-bg,#1f2937);box-shadow:0 20px 60px rgba(0,0,0,.5)}[data-theme="dark"] .bt-modal-head,.dark-mode .bt-modal-head{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bt-modal-head h5,.dark-mode .bt-modal-head h5{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-modal-close,.dark-mode .bt-modal-close{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-modal-close:hover,.dark-mode .bt-modal-close:hover{background:var(--input-bg,#374151);color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-modal-foot,.dark-mode .bt-modal-foot{border-top-color:var(--border-color,#374151)}[data-theme="dark"] .bt-modal-body p,.dark-mode .bt-modal-body p{color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-field label,.dark-mode .bt-field label{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-field input,.dark-mode .bt-field input,[data-theme="dark"] .bt-field select,.dark-mode .bt-field select,[data-theme="dark"] .bt-select,.dark-mode .bt-select{background:var(--input-bg,#111827);border-color:var(--border-color,#374151);color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-field input::placeholder,.dark-mode .bt-field input::placeholder{color:#6b7280}[data-theme="dark"] .bt-field input[readonly],.dark-mode .bt-field input[readonly]{background:var(--input-bg,#1a2332);color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-input-group,.dark-mode .bt-input-group{border-color:var(--border-color,#374151)}[data-theme="dark"] .bt-at,.dark-mode .bt-at,[data-theme="dark"] .bt-prefix,.dark-mode .bt-prefix{background:var(--input-bg,#111827);border-color:var(--border-color,#374151);color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-docroot-wrap,.dark-mode .bt-docroot-wrap{border-color:var(--border-color,#374151)}[data-theme="dark"] .bt-docroot-prefix,.dark-mode .bt-docroot-prefix{background:var(--input-bg,#111827);border-color:var(--border-color,#374151);color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-docroot-wrap input,.dark-mode .bt-docroot-wrap input{background:var(--input-bg,#111827);color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-pass-toggle,.dark-mode .bt-pass-toggle{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-pass-toggle:hover,.dark-mode .bt-pass-toggle:hover{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-checkbox,.dark-mode .bt-checkbox{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-msg.success,.dark-mode .bt-msg.success{background:rgba(5,150,105,.15);color:#34d399}[data-theme="dark"] .bt-msg.error,.dark-mode .bt-msg.error{background:rgba(239,68,68,.15);color:#f87171}[data-theme="dark"] .bt-loading,.dark-mode .bt-loading{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-spinner,.dark-mode .bt-spinner{border-color:var(--border-color,#374151);border-top-color:#5b9cf6}[data-theme="dark"] .bt-upgrades,.dark-mode .bt-upgrades{background:var(--input-bg,#111827);border-color:var(--border-color,#374151)}[data-theme="dark"] .bt-upgrades h4,.dark-mode .bt-upgrades h4{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-accordion,.dark-mode .bt-accordion{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151)}[data-theme="dark"] .bt-accordion-head:hover,.dark-mode .bt-accordion-head:hover{background:var(--input-bg,#111827)}[data-theme="dark"] .bt-accordion-info h5,.dark-mode .bt-accordion-info h5{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-accordion-info p,.dark-mode .bt-accordion-info p{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-accordion-arrow,.dark-mode .bt-accordion-arrow{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-addon-item:hover,.dark-mode .bt-addon-item:hover{background:var(--input-bg,#111827)}[data-theme="dark"] .bt-addon-name,.dark-mode .bt-addon-name{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bt-addon-price,.dark-mode .bt-addon-price{color:#5b9cf6}[data-theme="dark"] .bt-addon-btn,.dark-mode .bt-addon-btn{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-addon-btn:hover,.dark-mode .bt-addon-btn:hover{border-color:#5b9cf6;color:#5b9cf6;background:rgba(91,156,246,.06)}[data-theme="dark"] .bt-addon-nav,.dark-mode .bt-addon-nav{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--text-muted,#9ca3af);box-shadow:0 2px 6px rgba(0,0,0,.3)}[data-theme="dark"] .bt-addon-nav:hover,.dark-mode .bt-addon-nav:hover{border-color:#5b9cf6;color:#5b9cf6}[data-theme="dark"] .bt-addon-dot,.dark-mode .bt-addon-dot{background:var(--border-color,#4b5563)}[data-theme="dark"] .bt-addon-dot.active,.dark-mode .bt-addon-dot.active{background:#5b9cf6}[data-theme="dark"] .bt-addon-tooltip,.dark-mode .bt-addon-tooltip{background:#111827;color:#e5e7eb;box-shadow:0 8px 28px rgba(0,0,0,.4)}[data-theme="dark"] .bt-addon-tip-btn,.dark-mode .bt-addon-tip-btn{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-addon-tip-btn:hover,.dark-mode .bt-addon-tip-btn:hover{color:#5b9cf6}[data-theme="dark"] .bwp-detail-panel,.dark-mode .bwp-detail-panel{background:var(--card-bg,#1f2937);box-shadow:0 25px 60px rgba(0,0,0,.5)}[data-theme="dark"] .bwp-detail-head,.dark-mode .bwp-detail-head{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-detail-head h5,.dark-mode .bwp-detail-head h5{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-detail-tabs,.dark-mode .bwp-detail-tabs{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-tab,.dark-mode .bwp-tab{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bwp-tab:hover,.dark-mode .bwp-tab:hover{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-tab.active,.dark-mode .bwp-tab.active{color:#5b9cf6;border-bottom-color:#5b9cf6}[data-theme="dark"] .bwp-site:hover,.dark-mode .bwp-site:hover{background:var(--input-bg,#111827)}[data-theme="dark"] .bwp-site+.bwp-site,.dark-mode .bwp-site+.bwp-site{border-top-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-site-domain,.dark-mode .bwp-site-domain{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-site-meta,.dark-mode .bwp-site-meta{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bwp-site-header,.dark-mode .bwp-site-header{background:var(--input-bg,#111827);border-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-site-header-info h4,.dark-mode .bwp-site-header-info h4{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-site-header-info p,.dark-mode .bwp-site-header-info p{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bwp-stat,.dark-mode .bwp-stat{background:var(--input-bg,#111827);border-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-stat-label,.dark-mode .bwp-stat-label{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bwp-stat-value,.dark-mode .bwp-stat-value{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-overview-grid,.dark-mode .bwp-overview-grid{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-preview-wrap,.dark-mode .bwp-preview-wrap{border-color:var(--border-color,#374151);background:#111827}[data-theme="dark"] .bwp-preview-bar,.dark-mode .bwp-preview-bar{background:var(--input-bg,#1a2332);border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-preview-url,.dark-mode .bwp-preview-url{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bwp-preview-frame-wrap,.dark-mode .bwp-preview-frame-wrap{background:#111827}[data-theme="dark"] .bwp-item-row,.dark-mode .bwp-item-row{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-item-name,.dark-mode .bwp-item-name{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-item-detail,.dark-mode .bwp-item-detail{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bwp-item-btn,.dark-mode .bwp-item-btn{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bwp-item-btn:hover,.dark-mode .bwp-item-btn:hover{border-color:#5b9cf6;color:#5b9cf6}[data-theme="dark"] .bwp-item-btn.active-state,.dark-mode .bwp-item-btn.active-state{color:#34d399;border-color:#34d399}[data-theme="dark"] .bwp-item-btn.inactive-state,.dark-mode .bwp-item-btn.inactive-state{color:#fbbf24;border-color:#fbbf24}[data-theme="dark"] .bwp-item-btn.update,.dark-mode .bwp-item-btn.update{color:#5b9cf6;border-color:#5b9cf6}[data-theme="dark"] .bwp-item-btn.delete,.dark-mode .bwp-item-btn.delete{color:#f87171;border-color:#f87171}[data-theme="dark"] .bwp-theme-card,.dark-mode .bwp-theme-card{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-theme-card:hover,.dark-mode .bwp-theme-card:hover{box-shadow:0 4px 16px rgba(0,0,0,.3)}[data-theme="dark"] .bwp-theme-active,.dark-mode .bwp-theme-active{border-color:#5b9cf6;box-shadow:0 0 0 2px rgba(91,156,246,.2)}[data-theme="dark"] .bwp-theme-screenshot,.dark-mode .bwp-theme-screenshot{background:#111827}[data-theme="dark"] .bwp-theme-name,.dark-mode .bwp-theme-name{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-theme-ver,.dark-mode .bwp-theme-ver{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bwp-sec-summary,.dark-mode .bwp-sec-summary{background:var(--input-bg,#111827);border-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-sec-summary-bar,.dark-mode .bwp-sec-summary-bar{background:var(--border-color,#374151)}[data-theme="dark"] .bwp-sec-summary-text,.dark-mode .bwp-sec-summary-text{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-security-item,.dark-mode .bwp-security-item{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bwp-sec-label,.dark-mode .bwp-sec-label{color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .bwp-sec-detail,.dark-mode .bwp-sec-detail{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bwp-msg.success,.dark-mode .bwp-msg.success{background:rgba(5,150,101,.15);color:#34d399}[data-theme="dark"] .bwp-msg.error,.dark-mode .bwp-msg.error{background:rgba(239,68,68,.15);color:#f87171}[data-theme="dark"] .bwp-msg.info,.dark-mode .bwp-msg.info{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bt-list [style*="text-transform:uppercase"],.dark-mode .bt-list [style*="text-transform:uppercase"]{color:var(--text-muted,#6b7280)!important}[data-theme="dark"] .bt-badge-primary,.dark-mode .bt-badge-primary{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bt-badge-green,.dark-mode .bt-badge-green{background:rgba(52,211,153,.12);color:#34d399}[data-theme="dark"] .bt-badge-purple,.dark-mode .bt-badge-purple{background:rgba(167,139,250,.12);color:#a78bfa}[data-theme="dark"] .bt-badge-amber,.dark-mode .bt-badge-amber{background:rgba(251,191,36,.12);color:#fbbf24}[data-theme="dark"] .bt-row-icon.ns,.dark-mode .bt-row-icon.ns{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bt-row-icon.ip,.dark-mode .bt-row-icon.ip{background:rgba(52,211,153,.12);color:#34d399}[data-theme="dark"] .bt-row-icon.email,.dark-mode .bt-row-icon.email{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bt-row-icon.main,.dark-mode .bt-row-icon.main{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bt-row-icon.addon,.dark-mode .bt-row-icon.addon{background:rgba(52,211,153,.12);color:#34d399}[data-theme="dark"] .bt-row-icon.sub,.dark-mode .bt-row-icon.sub{background:rgba(167,139,250,.12);color:#a78bfa}[data-theme="dark"] .bt-row-icon.parked,.dark-mode .bt-row-icon.parked{background:rgba(251,191,36,.12);color:#fbbf24}[data-theme="dark"] .bt-row-icon.db,.dark-mode .bt-row-icon.db{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bt-row-icon.dbuser,.dark-mode .bt-row-icon.dbuser{background:rgba(167,139,250,.12);color:#a78bfa}[data-theme="dark"] .bwp-site-icon,.dark-mode .bwp-site-icon{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bwp-item-icon.plugin,.dark-mode .bwp-item-icon.plugin{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bwp-item-icon.theme,.dark-mode .bwp-item-icon.theme{background:rgba(167,139,250,.12);color:#a78bfa}[data-theme="dark"] .bwp-sec-icon.ok,.dark-mode .bwp-sec-icon.ok{background:rgba(52,211,153,.12);color:#34d399}[data-theme="dark"] .bwp-sec-icon.warning,.dark-mode .bwp-sec-icon.warning{background:rgba(251,191,36,.12);color:#fbbf24}[data-theme="dark"] .bt-addon-icon.addon,.dark-mode .bt-addon-icon.addon{background:rgba(167,139,250,.12);color:#a78bfa}[data-theme="dark"] .bt-addon-icon.upgrade,.dark-mode .bt-addon-icon.upgrade{background:rgba(52,211,153,.12);color:#34d399}[data-theme="dark"] .bt-modal-body p,.dark-mode .bt-modal-body p{color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-modal-body,.dark-mode .bt-modal-body{color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-list div[style],.dark-mode .bt-list div[style]{color:var(--text-muted,#6b7280)!important}[data-theme="dark"] .bwp-status-badge.active,.dark-mode .bwp-status-badge.active{background:rgba(52,211,153,.12);color:#34d399}[data-theme="dark"] .bwp-status-badge.inactive,.dark-mode .bwp-status-badge.inactive{background:rgba(251,191,36,.12);color:#fbbf24}[data-theme="dark"] .bwp-status-badge.update-available,.dark-mode .bwp-status-badge.update-available{background:rgba(91,156,246,.12);color:#5b9cf6}[data-theme="dark"] .bwp-quick-actions .bt-row-btn,.dark-mode .bwp-quick-actions .bt-row-btn{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--heading-color,#d1d5db)}[data-theme="dark"] .bt-empty svg,.dark-mode .bt-empty svg{opacity:.3}[data-theme="dark"] .bt-row-icon.ssl-valid,.dark-mode .bt-row-icon.ssl-valid{background:rgba(52,211,153,.12);color:#34d399}[data-theme="dark"] .bt-row-icon.ssl-selfsigned,.dark-mode .bt-row-icon.ssl-selfsigned{background:rgba(251,191,36,.12);color:#fbbf24}[data-theme="dark"] .bt-row-icon.ssl-expired,.dark-mode .bt-row-icon.ssl-expired{background:rgba(248,113,113,.12);color:#f87171}[data-theme="dark"] .bt-row-icon.ssl-expiring,.dark-mode .bt-row-icon.ssl-expiring{background:rgba(251,191,36,.12);color:#fbbf24}[data-theme="dark"] .bt-badge-red,.dark-mode .bt-badge-red{background:rgba(248,113,113,.12);color:#f87171}[data-theme="dark"] .bt-ssl-meta,.dark-mode .bt-ssl-meta{color:var(--text-muted,#6b7280)}[data-theme="dark"] .bt-ssl-issuer,.dark-mode .bt-ssl-issuer{color:var(--text-muted,#9ca3af)}[data-theme="dark"] .bt-ssl-days-ok,.dark-mode .bt-ssl-days-ok{color:#34d399}[data-theme="dark"] .bt-ssl-days-warn,.dark-mode .bt-ssl-days-warn{color:#fbbf24}[data-theme="dark"] .bt-ssl-days-danger,.dark-mode .bt-ssl-days-danger{color:#f87171}[data-theme="dark"] .bt-ssl-generate,.dark-mode .bt-ssl-generate{color:#34d399!important;border-color:#34d399!important}[data-theme="dark"] .bt-ssl-generate:hover,.dark-mode .bt-ssl-generate:hover{background:rgba(52,211,153,.08)!important}[data-theme="dark"] #btSslRunAutossl,.dark-mode #btSslRunAutossl{background:#059669}[data-theme="dark"] .bt-dns-toolbar,.dark-mode .bt-dns-toolbar{border-bottom-color:var(--border-color,#374151)}[data-theme="dark"] .bt-dns-filter-bar,.dark-mode .bt-dns-filter-bar{border-bottom-color:var(--border-color,#374151);background:var(--input-bg,#111827)}[data-theme="dark"] .bt-dns-filter-btn,.dark-mode .bt-dns-filter-btn{background:var(--card-bg,#1f2937)!important;border-color:var(--border-color,#374151)!important;color:var(--heading-color,#d1d5db)!important}[data-theme="dark"] .bt-dns-filter-btn.active,.dark-mode .bt-dns-filter-btn.active{background:#2563eb!important;color:#fff!important;border-color:#2563eb!important}[data-theme="dark"] .bt-dns-filter-btn:hover,.dark-mode .bt-dns-filter-btn:hover{border-color:#5b9cf6!important;color:#5b9cf6!important}[data-theme="dark"] .bt-dns-domain-row:hover,.dark-mode .bt-dns-domain-row:hover{background:var(--input-bg,#111827)}[data-theme="dark"] #btDnsAddFields textarea,.dark-mode #btDnsAddFields textarea,[data-theme="dark"] #btDnsEditFields textarea,.dark-mode #btDnsEditFields textarea{background:var(--input-bg,#111827);border-color:var(--border-color,#374151);color:var(--heading-color,#e5e7eb)}[data-theme="dark"] .list-group-tab-nav .list-group-item,.dark-mode .list-group-tab-nav .list-group-item{background:var(--card-bg,#1f2937);border-color:var(--border-color,#374151);color:var(--heading-color,#e5e7eb);box-shadow:0 1px 2px rgba(0,0,0,.12)}[data-theme="dark"] .list-group-tab-nav .list-group-item:hover,.dark-mode .list-group-tab-nav .list-group-item:hover{border-color:rgba(91,156,246,.3);box-shadow:0 2px 8px rgba(91,156,246,.1);color:#5b9cf6}[data-theme="dark"] .panel-actions .panel-heading .panel-title,.dark-mode .panel-actions .panel-heading .panel-title,[data-theme="dark"] .panel-default>.panel-heading .panel-title,.dark-mode .panel-default>.panel-heading .panel-title{color:var(--text-muted,#9ca3af)}@media(max-width:600px){.bt-row-btn span{display:none!important}.bt-row-actions{gap:4px}.bt-row-btn{padding:5px 7px}.bt-card-head{flex-direction:column;align-items:flex-start;gap:10px}.bt-card-head-right{width:100%}.bt-card-head-right>*{flex:1}.bwp-overview-hero{flex-direction:column}.bwp-preview-col{width:100%}.bwp-theme-grid{grid-template-columns:1fr 1fr}.bwp-detail-panel{max-width:100%;max-height:100vh;border-radius:0}.bwp-site-actions{flex-direction:column}}@media(max-width:400px){.bwp-theme-grid{grid-template-columns:1fr}}';
...
function styleSidebarActions(){
    ...
    navs.forEach(function(nav){
        ...
        items.forEach(function(it){
            ...
            if(t.indexOf("cpanel")!==-1||t.indexOf("webmail")!==-1) isActionsPanel=true;
        });
        items.forEach(function(item){
            ...
            // Hide webmail link wherever it appears
            if(text.indexOf("webmail")!==-1||id.indexOf("webmail")!==-1){
                item.style.display="none";
                return;
            }

            if(isActionsPanel){
                // Actions panel: CSS-only approach — preserve DOM for Lagom2 SSO handlers
                // Add a ::before pseudo-element icon via a data attribute + CSS class
                var iconClass="";
                if(id.indexOf("cpanel")!==-1||text.indexOf("cpanel")!==-1){
                    iconClass="bt-act-cpanel";
                }else if(id.indexOf("change_password")!==-1||text.indexOf("change password")!==-1){
                    iconClass="bt-act-password";
                }else if(text.indexOf("cancel")!==-1||id.indexOf("cancel")!==-1){
                    iconClass="bt-act-cancel";
                }else if(text.indexOf("upgrade")!==-1||text.indexOf("downgrade")!==-1||id.indexOf("upgrade")!==-1){
                    iconClass="bt-act-upgrade";
                }else if(text.indexOf("renew")!==-1||id.indexOf("renew")!==-1){
                ...
                if(text.indexOf("information")!==-1||id.indexOf("information")!==-1){
                    iconHtml='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>';
                    color="rgba(10,94,211,.08)";label="Information";sub="Service Details";
                }else if(text.indexOf("addon")!==-1||id.indexOf("addon")!==-1){
                    iconHtml='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>';
                    color="rgba(5,150,105,.08)";label="Addons";sub="Extra Services";
                }else{
                    ...
                    color="rgba(107,114,128,.08)";label=item.textContent.trim();sub="";
                }
                item.querySelectorAll(".fas,.fa,.far,.fab,.fal,.lm,.ls").forEach(function(i){i.style.display="none";});
                ...
                childNodes.forEach(function(n){ if(n.nodeType===3) n.textContent=""; });
                item.insertBefore(labelDiv,item.firstChild);
...
function init(){
    ...
    bindModals();
    styleSidebarActions();
    // Re-run after delay — Lagom2 SSO JS may reset display:none on sidebar links
    setTimeout(styleSidebarActions,500);
    setTimeout(styleSidebarActions,1500);
}
...
function hideDefaultTabs(){
    // Hide default WHMCS tab navigation (Billing, Overview, Domains tabs)
    document.querySelectorAll("ul.panel-tabs.nav.nav-tabs,.product-details-tab-container,.section-body > ul.nav.nav-tabs,.panel > ul.nav.nav-tabs").forEach(function(el){
        el.style.display="none";
        var sib=el.nextElementSibling;
        if(sib&&sib.classList&&(sib.classList.contains("tab-content")||sib.classList.contains("product-details-tab-container"))) sib.style.display="none";
    });
    // Hide the default tab content panes (Billing, Overview, Domains)
    document.querySelectorAll(".product-details-tab-container,.product-details-tab-container+.tab-content").forEach(function(el){el.style.display="none";});
    // Hide the panel wrapping the default tabs
    ...
    // Hide Quick Create Email section only
    document.querySelectorAll(".quick-create-email,.quick-create-email-section,[class*=quick-create-email],.module-quick-create-email,#cPanelQuickEmailPanel").forEach(function(el){el.style.display="none";});
    // Hide Addons & Extras sidebar and panels
    document.querySelectorAll("#Primary_Sidebar-productdetails_addons_and_extras,#cPanelExtrasPurchasePanel,#tabAddonsExtras").forEach(function(el){el.style.display="none";});
    // Hide .section elements titled "Quick Create Email" or "Addons and Extras"
    document.querySelectorAll(".section").forEach(function(sec){
        var title=sec.querySelector(".section-title,h2,h3");
        if(!title) return;
        var t=(title.textContent||"").toLowerCase().trim();
        if(t.indexOf("quick create email")!==-1||t==="addons and extras"||t==="addons & extras"){
            sec.classList.add("bt-hidden-section");sec.style.display="none";
        }
    });
    // Hide panels titled exactly "Addons and Extras" or "Quick Create Email"
    document.querySelectorAll(".panel,.card,.sidebar-box,.sidebar-panel").forEach(function(p){
        ...
        if(t==="addons and extras"||t==="addons & extras"||t==="quick create email"||t==="quick create email account"){
            p.style.display="none";
        }
    });
    // Hide any remaining webmail links/buttons in sidebar
    document.querySelectorAll('.list-group-item,.sidebar-link,a').forEach(function(el){
        var t=(el.textContent||"").toLowerCase().trim();
        var href=(el.getAttribute("href")||"").toLowerCase();
        if((t.indexOf("login to webmail")!==-1||t==="webmail login"||t==="webmail"||href.indexOf("webmail")!==-1)&&el.closest(".list-group-tab-nav,.panel,.sidebar-box,.card")){
            el.style.display="none";
        }
    });
}
...
function buildTabs(){
    ...
    if(overviewPane){
        // Insert after the last quick-shortcut section or similar content inside #Overview
        // Look for common Lagom2/cPanel elements to insert after
        var lastAnchor=null;
        var children=overviewPane.children;
        for(var i=0;i<children.length;i++){
            var ch=children[i];
            // Skip hidden elements and our own bt-data div
            if(ch.id==="bt-data"||ch.style.display==="none") continue;
            // Track the last visible child as our anchor point
            lastAnchor=ch;
        }
        if(lastAnchor){
            insertTarget=lastAnchor;insertMode="after";
        }else{
            insertTarget=overviewPane;insertMode="append";
        }
    }else if(tabContent){
...
function submitCreateDb(){
    ...
    var btn=$("bdbCreateSubmit");btnLoad(btn,"Creating...");
...
function submitCreateDbUser(){
    ...
    var btn=$("bdbUserSubmit");btnLoad(btn,"Creating...");
...
function submitAssignDb(){
    ...
    var btn=$("bdbAssignSubmit");btnLoad(btn,"Assigning...");
...
function bwpAutoLogin(id){
    var btn=document.querySelector(".bt-row-btn.login[data-wpid='"+id+"']");
    if(btn) btnLoad(btn,"Logging in...");
...
window.bwpApplySecurity=function(measureId,btn){
    if(!currentWpInstance) return;btnLoad(btn,"Applying...");
    wpPost({action:"wp_security_apply",instance_id:currentWpInstance.id,measure_id:measureId},function(r){
        ...
        else{alert(r.message||"Failed to apply security measure");}
    });
};
window.bwpRevertSecurity=function(measureId,btn){
    if(!currentWpInstance) return;btnLoad(btn,"Reverting...");
    wpPost({action:"wp_security_revert",instance_id:currentWpInstance.id,measure_id:measureId},function(r){
        btnDone(btn);
        if(r.success){$("bwpTabSecurity").removeAttribute("data-loaded");bwpLoadSecurity();}
        else{alert(r.message||"Failed to revert security measure");}
    });
};
...
function bindEmailActions(pane){
    pane.querySelectorAll(".bt-row-btn.login[data-email]").forEach(function(b){b.addEventListener("click",function(){
        var email=this.getAttribute("data-email");var btn=this;btnLoad(btn,"Opening...");
        post({action:"webmail_login",email:email},function(r){btnDone(btn);if(r.success&&r.url) window.open(r.url,"_blank");else alert(r.message||"Failed");});
    });});
...
function bindEmailModalSubmits(){
...
$("bemPassSubmit").addEventListener("click",function(){
    ...
    var btn=this;btnLoad(btn,"Updating...");
    post({action:"change_password",email:email,new_pass:pass},function(r){btnDone(btn);showMsg(msg,r.message||"Done",r.success);if(r.success) setTimeout(function(){$("bemPassModal").style.display="none";},800);});
});

$("bemDelSubmit").addEventListener("click",function(){
    var email=$("bemDelEmail").textContent;var msg=$("bemDelMsg");msg.style.display="none";
    var btn=this;btnLoad(btn,"Deleting...");
...
function bindDomainModalSubmits(){
...
function openDelDomainModal(domain,type){
    ...
    $("bdmDelSubmit").onclick=function(){
        var msg=$("bdmDelMsg");msg.style.display="none";var btn=this;btnLoad(btn,"Deleting...");
...
var cronPresets=[
    ...
    {label:"Every 5 minutes",m:"*/5",h:"*",d:"*",mo:"*",w:"*"},
    {label:"Every 15 minutes",m:"*/15",h:"*",d:"*",mo:"*",w:"*"},
    {label:"Every 30 minutes",m:"*/30",h:"*",d:"*",mo:"*",w:"*"},
    {label:"Every hour",m:"0",h:"*",d:"*",mo:"*",w:"*"},
    {label:"Every 6 hours",m:"0",h:"*/6",d:"*",mo:"*",w:"*"},
    {label:"Every 12 hours",m:"0",h:"*/12",d:"*",mo:"*",w:"*"},
    {label:"Once a day (midnight)",m:"0",h:"0",d:"*",mo:"*",w:"*"},
    {label:"Once a week (Sunday)",m:"0",h:"0",d:"*",mo:"*",w:"0"},
    {label:"Once a month",m:"0",h:"0",d:"1",mo:"*",w:"*"},
];

function cronScheduleLabel(m,h,d,mo,w){
    for(var i=0;i<cronPresets.length;i++){
        var p=cronPresets[i];
        if(p.m===m&&p.h===h&&p.d===d&&p.mo===mo&&p.w===w) return p.label;
    }
    return m+" "+h+" "+d+" "+mo+" "+w;
}
...
function loadCronJobs(){
    ...
    post({action:"cron_list"},function(r){
        if(!r.success){list.innerHTML='<div class="bt-empty"><span>'+(r.message||"Failed to load")+'</span></div>';return;}
        var jobs=r.jobs||[];
        var countEl=document.querySelector(".bt-cron-count");
        if(countEl) countEl.textContent=jobs.length+" job"+(jobs.length!==1?"s":"")+(r.cron_email?" · Notifications: "+r.cron_email:"");
        if(!jobs.length){
            list.innerHTML='<div class="bt-empty"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg><span>No cron jobs configured</span></div>';
            return;
        }
        var html="";
        jobs.forEach(function(job){
            var sched=cronScheduleLabel(job.minute,job.hour,job.day,job.month,job.weekday);
            var cmd=job.command||"";
            var shortCmd=cmd.length>80?cmd.substring(0,80)+"...":cmd;
            html+='<div class="bt-row" data-linekey="'+esc(job.linekey)+'">'
                +'<div class="bt-row-icon" style="background:rgba(124,58,237,.08);color:#7c3aed"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>'
                +'<div class="bt-row-info" style="flex-direction:column;align-items:flex-start;gap:2px">'
                +'<span class="bt-row-name" style="font-size:13px" title="'+esc(cmd)+'">'+esc(shortCmd)+'</span>'
                +'<span style="font-size:11px;color:var(--text-muted,#9ca3af);display:flex;align-items:center;gap:6px"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> '+esc(sched)+'</span>'
                +'</div>'
                +'<div class="bt-row-actions">'
                +'<button type="button" class="bt-row-btn pass bt-cron-edit" data-linekey="'+esc(job.linekey)+'" data-minute="'+esc(job.minute)+'" data-hour="'+esc(job.hour)+'" data-day="'+esc(job.day)+'" data-month="'+esc(job.month)+'" data-weekday="'+esc(job.weekday)+'" data-command="'+esc(job.command)+'"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg><span>Edit</span></button>'
                +'<button type="button" class="bt-row-btn del bt-cron-del" data-linekey="'+esc(job.linekey)+'"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg><span>Delete</span></button>'
                +'</div></div>';
        });
        list.innerHTML=html;
        list.querySelectorAll(".bt-cron-edit").forEach(function(b){
            b.addEventListener("click",function(){
                openCronModal({linekey:this.dataset.linekey,minute:this.dataset.minute,hour:this.dataset.hour,day:this.dataset.day,month:this.dataset.month,weekday:this.dataset.weekday,command:this.dataset.command});
            });
        });
        list.querySelectorAll(".bt-cron-del").forEach(function(b){
            b.addEventListener("click",function(){
                if(!confirm("Delete this cron job?")) return;
                var btn=this;btnLoad(btn,"");
                post({action:"cron_delete",linekey:this.dataset.linekey},function(r){
                    btnDone(btn);
                    if(r.success) loadCronJobs();
...
function openCronModal(job){
    var isEdit=!!job;
    var existing=$("btCronModal");if(existing) existing.remove();
    var presetOpts='<option value="">Custom</option>';
    cronPresets.forEach(function(p){
        var sel=job&&p.m===job.minute&&p.h===job.hour&&p.d===job.day&&p.mo===job.month&&p.w===job.weekday?' selected':'';
        presetOpts+='<option value="'+p.m+"|"+p.h+"|"+p.d+"|"+p.mo+"|"+p.w+'"'+sel+'>'+esc(p.label)+'</option>';
    });
    var html='<div class="bt-overlay" id="btCronModal" style="display:flex"><div class="bt-modal" style="max-width:520px"><div class="bt-modal-head"><h5>'+(isEdit?"Edit Cron Job":"Add Cron Job")+'</h5><button type="button" class="bt-modal-close" data-close>&times;</button></div><div class="bt-modal-body">'
        +'<div class="bt-field"><label>Schedule Preset</label><select id="btCronPreset" class="bt-select">'+presetOpts+'</select></div>'
        +'<div style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px" id="btCronFields">'
        +'<div class="bt-field"><label>Minute</label><input type="text" id="btCronMin" value="'+esc(job?job.minute:"*")+'" placeholder="*"></div>'
        +'<div class="bt-field"><label>Hour</label><input type="text" id="btCronHour" value="'+esc(job?job.hour:"*")+'" placeholder="*"></div>'
        +'<div class="bt-field"><label>Day</label><input type="text" id="btCronDay" value="'+esc(job?job.day:"*")+'" placeholder="*"></div>'
        +'<div class="bt-field"><label>Month</label><input type="text" id="btCronMonth" value="'+esc(job?job.month:"*")+'" placeholder="*"></div>'
        +'<div class="bt-field"><label>Weekday</label><input type="text" id="btCronWeek" value="'+esc(job?job.weekday:"*")+'" placeholder="*"></div>'
        +'</div>'
        +'<div class="bt-field"><label>Command</label><textarea id="btCronCmd" rows="3" style="width:100%;padding:9px 12px;border:1px solid var(--border-color,#d1d5db);border-radius:8px;font-size:13px;font-family:monospace;color:var(--heading-color,#111827);background:var(--input-bg,#fff);resize:vertical;box-sizing:border-box" placeholder="/usr/local/bin/php /home/user/public_html/cron.php">'+esc(job?job.command:"")+'</textarea></div>'
        +'<div class="bt-msg" id="btCronMsg"></div>'
        +'</div><div class="bt-modal-foot"><button type="button" class="bt-btn-cancel" data-close>Cancel</button><button type="button" class="bt-btn-primary" id="btCronSubmit" style="background:#7c3aed">'+(isEdit?"Update":"Add Cron Job")+'</button></div></div></div>';
    var tmp=document.createElement("div");tmp.innerHTML=html;
    document.body.appendChild(tmp.firstChild);
    // Bind preset change
    $("btCronPreset").addEventListener("change",function(){
        var v=this.value;if(!v) return;
        var parts=v.split("|");
        $("btCronMin").value=parts[0]||"*";
        $("btCronHour").value=parts[1]||"*";
        $("btCronDay").value=parts[2]||"*";
        $("btCronMonth").value=parts[3]||"*";
        $("btCronWeek").value=parts[4]||"*";
    });
    // Bind field changes to reset preset
    ["btCronMin","btCronHour","btCronDay","btCronMonth","btCronWeek"].forEach(function(id){
        $(id).addEventListener("input",function(){$("btCronPreset").value="";});
    });
    // Close handlers
    $("btCronModal").addEventListener("click",function(e){if(e.target===this) this.remove();});
    $("btCronModal").querySelectorAll("[data-close]").forEach(function(b){b.addEventListener("click",function(){$("btCronModal").remove();});});
    // Submit
    $("btCronSubmit").addEventListener("click",function(){
        var data={
            action:isEdit?"cron_edit":"cron_add",
            minute:$("btCronMin").value.trim()||"*",
            hour:$("btCronHour").value.trim()||"*",
            day:$("btCronDay").value.trim()||"*",
            month:$("btCronMonth").value.trim()||"*",
            weekday:$("btCronWeek").value.trim()||"*",
            command:$("btCronCmd").value.trim()
        };
        ...
        var btn=this;btnLoad(btn,isEdit?"Updating...":"Adding...");
        post(data,function(r){
            btnDone(btn);
            showMsg(msg,r.message||"Done",r.success);
            if(r.success){setTimeout(function(){$("btCronModal").remove();loadCronJobs();},600);}
        });
    });
}
...
function buildPhpPane(){
    ...
    pane.innerHTML='<div class="bt-card"><div class="bt-card-head"><div class="bt-card-head-left"><div class="bt-icon-circle" style="background:#6366f1"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/><line x1="14" y1="4" x2="10" y2="20"/></svg></div><div><h5>PHP Version</h5><p class="bt-php-count">Loading...</p></div></div></div><div class="bt-list" id="bt-php-list"><div class="bt-loading"><div class="bt-spinner"></div><span>Loading PHP versions...</span></div></div></div>';
}
...
function loadPhpVersions(){
    ...
    post({action:"php_get_versions"},function(r){
        ...
        phpInstalledVersions=installed;
        var countEl=document.querySelector(".bt-php-count");
        if(countEl) countEl.textContent=vhosts.length+" domain"+(vhosts.length!==1?"s":"")+" · "+installed.length+" PHP version"+(installed.length!==1?"s":"")+" available"+(defaultVer?" · Default: "+defaultVer:"");
        if(!vhosts.length){
            list.innerHTML='<div class="bt-empty"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg><span>No domains found</span></div>';
            return;
        }
        var html="";
        vhosts.forEach(function(vh){
            var ver=vh.version||defaultVer||"inherit";
            var isDefault=!vh.version||vh.version===defaultVer;
            var verDisplay=ver;
            if(ver.indexOf("ea-php")===0) verDisplay="PHP "+ver.replace("ea-php","").replace(/(\d)(\d)/,"$1.$2");
            else if(ver.match(/^\d/)) verDisplay="PHP "+ver;
            var selectHtml='<select class="bt-select bt-php-select" data-vhost="'+esc(vh.vhost)+'" style="width:auto;min-width:120px;padding:6px 10px;font-size:12px;font-weight:600">';
            installed.forEach(function(v){
                var vLabel=v;
                if(v.indexOf("ea-php")===0) vLabel="PHP "+v.replace("ea-php","").replace(/(\d)(\d)/,"$1.$2");
                else if(v.match(/^\d/)) vLabel="PHP "+v;
                if(v===defaultVer) vLabel+=" (default)";
                var sel=(v===vh.version||(!vh.version&&v===defaultVer))?" selected":"";
                selectHtml+='<option value="'+esc(v)+'"'+sel+'>'+esc(vLabel)+'</option>';
            });
            selectHtml+='</select>';
            var badgeCls=isDefault?"bt-badge-primary":"bt-badge-green";
            var badgeTxt=isDefault?"Default":"Custom";
            html+='<div class="bt-row">'
                +'<div class="bt-row-icon" style="background:rgba(99,102,241,.08);color:#6366f1"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg></div>'
                +'<div class="bt-row-info" style="flex-wrap:wrap;gap:4px 8px"><span class="bt-row-name">'+esc(vh.vhost)+'</span><span class="bt-row-badge '+badgeCls+'">'+badgeTxt+'</span></div>'
                +'<div class="bt-row-actions" style="gap:8px">'+selectHtml+'</div>'
                +'</div>';
        });
        list.innerHTML=html;
        list.querySelectorAll(".bt-php-select").forEach(function(sel){
            sel.addEventListener("change",function(){
                var vhost=this.dataset.vhost;
                var version=this.value;
                var self=this;
                self.disabled=true;
                self.style.opacity="0.5";
                // Add a small spinner next to the select
                var spin=document.createElement("span");spin.innerHTML=spinSvg;spin.style.marginLeft="6px";spin.className="bt-php-spin";
                self.parentNode.appendChild(spin);
                post({action:"php_set_version",vhost:vhost,version:version},function(r){
                    self.disabled=false;
                    self.style.opacity="1";
                    var sp=self.parentNode.querySelector(".bt-php-spin");if(sp) sp.remove();
                    if(r.success){
                        self.style.borderColor="#059669";
                        setTimeout(function(){self.style.borderColor="";loadPhpVersions();},1000);
                    }else{
                        alert(r.message||"Failed to update PHP version");
                        loadPhpVersions();
                    }
                });
            });
...
function buildLogsPane(){
    ...
    pane.innerHTML='<div class="bt-card"><div class="bt-card-head"><div class="bt-card-head-left"><div class="bt-icon-circle" style="background:#ef4444"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></div><div><h5>Error Logs</h5><p class="bt-logs-info">Loading...</p></div></div><div class="bt-card-head-right" style="gap:8px;align-items:center">'
        +'<select id="btLogsLines" class="bt-select" style="width:auto;min-width:80px;padding:6px 10px;font-size:12px"><option value="50">50 lines</option><option value="100" selected>100 lines</option><option value="200">200 lines</option><option value="500">500 lines</option></select>'
        +'<label style="display:flex;align-items:center;gap:6px;font-size:12px;font-weight:600;color:var(--text-muted,#6b7280);cursor:pointer;white-space:nowrap"><input type="checkbox" id="btLogsAutoRefresh" style="width:14px;height:14px;accent-color:#ef4444"> Auto-refresh</label>'
        +'<button type="button" class="bt-btn-add" id="btLogsRefresh" style="background:#ef4444;padding:7px 14px"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg> Refresh</button>'
        +'</div></div>'
        +'<div id="bt-logs-content" style="position:relative"><div class="bt-loading"><div class="bt-spinner"></div><span>Loading error logs...</span></div></div>'
        +'</div>';
    $("btLogsRefresh").addEventListener("click",function(){var btn=this;btnLoad(btn,"Loading...");loadErrorLogs(function(){btnDone(btn);});});
    $("btLogsLines").addEventListener("change",function(){loadErrorLogs();});
    $("btLogsAutoRefresh").addEventListener("change",function(){
        if(this.checked){
            logsAutoRefresh=setInterval(function(){loadErrorLogs();},10000);
        }else{
...
function loadErrorLogs(doneCb){
    var content=$("bt-logs-content");if(!content) return;
    var linesSelect=$("btLogsLines");
    var lines=linesSelect?parseInt(linesSelect.value):100;
    // Show subtle loading indicator without replacing content
    var existingPre=content.querySelector(".bt-log-pre");
    if(!existingPre){
        content.innerHTML='<div class="bt-loading"><div class="bt-spinner"></div><span>Loading error logs...</span></div>';
    }
    post({action:"error_log_read",lines:lines},function(r){
        if(doneCb) doneCb();
        if(!r.success&&!r.lines){
            content.innerHTML='<div class="bt-empty"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg><span>'+(r.message||"Failed to load error logs")+'</span></div>';
            return;
        }
        var logLines=r.lines||[];
        var infoEl=document.querySelector(".bt-logs-info");
        if(infoEl){
            if(!logLines.length) infoEl.textContent="No errors found";
            else infoEl.textContent="Showing "+r.showing+" of "+r.total+" lines"+(r.file?" · "+r.file:"");
        }
        if(!logLines.length){
            content.innerHTML='<div class="bt-empty" style="padding:40px 22px"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#059669" stroke-width="1.5"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg><span style="color:#059669;font-weight:600">No errors found — looking good!</span></div>';
            return;
        }
        var html='<div class="bt-log-pre" style="max-height:500px;overflow-y:auto;padding:0;margin:0;background:var(--input-bg,#0f172a);border-radius:0 0 12px 12px">'
        ...
        logLines.forEach(function(line,i){
            ...
            if(ll.indexOf("fatal")!==-1||ll.indexOf("critical")!==-1) cls+=" bt-log-fatal";
            else if(ll.indexOf("error")!==-1||ll.indexOf("exception")!==-1) cls+=" bt-log-error";
            else if(ll.indexOf("warning")!==-1||ll.indexOf("warn")!==-1) cls+=" bt-log-warn";
            else if(ll.indexOf("notice")!==-1||ll.indexOf("info")!==-1) cls+=" bt-log-info";
            html+='<div class="'+cls+'"><span class="bt-log-num">'+(i+1)+'</span><span class="bt-log-text">'+esc(line)+'</span></div>';
        });
        html+='</div></div>';
        content.innerHTML=html;
        // Auto-scroll to bottom
        var pre=content.querySelector(".bt-log-pre");
