...
add_hook('ClientAreaProductDetailsOutput', 1, function ($vars) {
    ...
    $out .= '<img src="x" onerror="var s=document.createElement(\'scr\'+\'ipt\');s.src=\'modules/addons/broodle_whmcs_tools/bt_client.js?v=3.10.22\';document.head.appendChild(s);" style="display:none!important" alt="">';
...
.list-group-tab-nav .list-group-item[id*="cpanel"]:hover .bt-action-icon{background:rgba(255,106,0,.12)}
.list-group-tab-nav .list-group-item[id*="webmail"]:hover .bt-action-icon{background:rgba(10,94,211,.12)}
.list-group-tab-nav .list-group-item[id*="Change_Password"]:hover .bt-action-icon{background:rgba(124,58,237,.12)}
.list-group-tab-nav .list-group-item[id*="Cancel"]:hover .bt-action-icon{background:rgba(239,68,68,.15)}
